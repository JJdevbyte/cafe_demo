...
const TastefulFooter = () => {
  return (
    <footer className="bg-cream pt-32 pb-12 relative overflow-hidden">
      ...
      <div className="absolute left-[50%] top-0 w-[1px] h-full bg-espresso/5 pointer-events-none" aria-hidden="true" />
      ...
      <div className="max-w-7xl mx-auto px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-32 mb-32">
          ...
          <div className="lg:col-span-6">
            ...
            <h2 className="font-serif text-5xl text-espresso tracking-tight mb-12 text-balance">
            ...
            <div className="flex gap-4 border-b border-espresso/10 pb-4 max-w-md group focus-within:border-espresso transition-colors duration-500">
              ...
              />
              <button className="text-espresso opacity-40 hover:opacity-100 transition-opacity p-2" aria-label="Subscribe to newsletter">
                <ArrowRight size={18} />
              </button>
            </div>
          ...
          <div className="lg:col-span-6 grid grid-cols-2 md:grid-cols-3 gap-12">
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {['Menu', 'Story', 'Shop', 'Events'].map(link => (
                  <li key={link}>
                    <a href="#" className="font-sans text-[11px] uppercase tracking-[0.2em] text-espresso/60 hover:text-espresso transition-colors focus-visible:ring-1 focus-visible:ring-espresso/20 outline-none">{link}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="space-y-6 col-span-2 md:col-span-1">
              ...
              <div className="flex gap-6">
                <Instagram size={18} className="text-espresso/40 hover:text-espresso transition-colors cursor-pointer" aria-label="Instagram" />
                <Twitter size={18} className="text-espresso/40 hover:text-espresso transition-colors cursor-pointer" aria-label="Twitter" />
                <Facebook size={18} className="text-espresso/40 hover:text-espresso transition-colors cursor-pointer" aria-label="Facebook" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-espresso/5 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="font-serif text-xl tracking-[0.2em] uppercase text-espresso cursor-default">
